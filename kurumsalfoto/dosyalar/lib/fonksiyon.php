...
class kurumsal {
    ...
    $hizmetlerbaslik, $haritabilgi, $footer,$renkkodu ;
    function __construct() {
   	...
   	$baglanti=new PDO("mysql:host=localhost;dbname=kurumsal;charset=utf8","root","");
            ...
            $ayarcek2 = $baglanti->prepare('SELECT * from icon');
            $ayarcek2->execute();
            $sorguson2 = $ayarcek2->fetch();
            $this->iconyol = $sorguson2['iconyol'];

            $ayarcek3 = $baglanti->prepare('SELECT * from logo');
            $ayarcek3->execute();
            $sorguson3 = $ayarcek3->fetch();
            $this->logoyol = $sorguson3['logoyol'];
            ...
            $this->renkkodu= $sorguson['renkkodu'];
        }
        ...
        function hakkimizda($baglanti){
           ...
           $sonucum = $introal->fetch();
             ...
             <div class="col-lg-6" style=" width:auto; height:100px;">
             <img src="'.$sonucum["resim"].'" alt="" style="width:auto; height:150px;"/>
             </div>
