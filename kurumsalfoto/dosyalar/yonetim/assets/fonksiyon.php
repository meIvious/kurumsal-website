...
document.onfocus = RestoreSubmitButton;
  ...
  <link rel="icon" type="image/png" href="../<?php echo $sinif->iconyol; ?>">
</head>
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
         <h4 class="modal-title">Küçük Bilgi</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
        <img src="https://i.ytimg.com/vi/MvPGgt3WrQ8/maxresdefault.jpg"/>
        <h7 class="modal-title">İcon Foto Örneği</h7>
        </div>
         <!-- Modal footer -->
 ...
 <div class="modal" id="myModal2">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
         <h4 class="modal-title">Harita Kodu Nasıl Kopyalanır ?</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
        <img src="https://www.ozengen.com/wp-content/uploads/2016/12/haritayi-yerlestir.jpg"/>
        </div>
         <!-- Modal footer -->
         <div class="modal-footer">
         <div class="alert alert-info" style="text-align:center">
         Harita kodunun site içinde sorunsuz çalışması için <strong>"iframe"</strong> kod bloğunu <strong>kopyalamayınız.</strong>
        </div>
 ...
 <div class="modal" id="myModal3">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
         <h4 class="modal-title">Renk Kodu</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
        <center><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNJg1HGmifRaV8JypygKk9NhPct76YsuPdxQ&usqp=CAU"/></center>
        </div>
         <!-- Modal footer -->
         <center><h6 >Renk Kodu Örneği</h6></center>
         <div class="modal-footer">
         <div class="alert alert-info" style="text-align:center">
         Renk kodunun site içinde sorunsuz çalışması için <strong>"#"</strong> kod bloğunu <strong>kopyalamayınız.</strong>
        </div>
        </div>
        </div>
      </div>
...
class yonetim 
{
    ...
    function siteayar($baglanti) {
        ...
        if($_POST):
            ...
            $renkkodu=htmlspecialchars($_POST["renkkodu"]);
            ...
            yorumbaslik=?,iletisimbaslik=?,hizmetlerbaslik=?,mesajtercih=?,haritabilgi=?,footer=?, renkkodu=?");
            ...
            $guncelleme->bindParam(24,$renkkodu,PDO::PARAM_STR);
            $guncelleme->execute();
      ...
      <form action="control.php?sayfa=siteayar" method="post">
        ...
        <div class="col-lg-9 p-1">
        <a href="control.php?sayfa=logoayar" type="button" class="btn btn-dark col-lg-5 p-1">
     Değiştir/Güncelle
     </a>
        </div>
        </div>
        ...
        <div class="row">
        <div class="col-lg-3 border-right pt-3 text-left">
        <span id="siteayarfont">Renk Kodu</span>
        </div>
        <div class="col-lg-9 p-1">
        <input type="text" name="renkkodu" class="form-control" placeholder="'#' kod bloğunu kopyalayamayınız." value="<?php echo $sonuc["renkkodu"];?>"  />
        <button type="button" class="btn btn-warning fa fa-info-circle" data-toggle="modal" data-target="#myModal3">
     Bilgi
     </button>
        </div>
        </div>
        ...
        <button type="button" class="btn btn-warning fa fa-info-circle" data-toggle="modal" data-target="#myModal2">
     Bilgi
     </button>
        </div>
        </div>
    ...
    function giriskontrol($kulad,$sifre,$vt)  {
        ...
        if($sor->rowCount()==0):
            ...
            <div class="alert alert-white border border-dark mt-5 col-md-5 mx-auto p-3 text-danger font-14 font-weight-bold"><img src="load.gif" class="mr-3">
            Bilgiler hatalı!</div>
            </div>';
        ...
        echo '
        <div class="container-fluid bg-white" >
        <div class="alert alert-white border border-dark mt-5 col-md-5 mx-auto p-3 text-success font-14 font-weight-bold"><img src="loader.gif" class="mr-3">
        Giriş başarılı!</div>
        </div>';
...
//veritabanına ekleme-----------
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    function iconayar($vt){
        echo '<div class="row text-center">
        <div class="col-lg-12">
		 <p class="card-text text-center text-danger border-bottom">
      * İcon değiştirmek için kullanılır. <br/><br/>
      <button type="button" class="btn btn-info fa fa-info-circle" data-toggle="modal" data-target="#myModal">
     İpucu
     </button>
      </p>
    ...
    //$introbilgiler=$vt->prepare("select * from galeri");
    $introbilgiler=self::sorgum($vt,"select * from icon",2);
    while($sonbilgi=$introbilgiler->fetch(PDO::FETCH_ASSOC)):
        echo '<div class="col-lg-4">
        <div class="row card-bordered  p-1 m-1">
        <div class="col-lg-12">
        <img src="../'.$sonbilgi["iconyol"].'">
        <kbd class="bg-white p-2" style="position:absolute; bottom:10px; right:10px;">
        <a href="control.php?sayfa=iconresimguncelle&id='.$sonbilgi["id"].'" class="ti-reload m-2 text-success" style="font-size:20px;"></a>
        </kbd>
        </div>
    ...
    function  iconresimguncelleme($vt){
        ...
        if($_POST):
            ...
            if($_FILES["dosya"]["name"]==""):
                echo '<div class="alert alert-danger mt-5">
                Dosya yüklenmedi, bu alan boş olamaz.</div>';
                header("refresh:2,url=control.php?sayfa=iconayar");
            else://bos degilese
                if($_FILES["dosya"]["size"]>(1024*1024*5)):
                    echo '<div class="alert alert-danger mt-5">
                    Dosya boyutu çok fazla!</div>';
                    ...
                    if(!in_array($_FILES["dosya"]["type"],$izinverilen)):
                       ...
                       header("refresh:2,url=control.php?sayfa=iconayar");
                        ...
                        //olanı sil yeniyi kaydet
                        $resimyolunabak=self::sorgum($vt,"select * from  icon where id=$gelenintroid",1);
                        $dbgelenyol='../'.$resimyolunabak["iconyol"];
                        unlink($dbgelenyol);
                        $dosyaminyolu='../img/icon/'.$_FILES["dosya"]["name"];
                    
                        move_uploaded_file($_FILES["dosya"]["tmp_name"],$dosyaminyolu);
                        $dosyaminyolu2=str_replace('../','',$dosyaminyolu);
                        self::sorgum($vt,"update  icon set iconyol='$dosyaminyolu2' where id=$gelenintroid",0);
                        echo '<div class="alert alert-success mt-5">
                        Güncelleme başarılı.</div>';
                        header("refresh:2,url=control.php?sayfa=iconayar");
...
//veritabanına ekleme-----------
             ...
             <div class="card card-bordered">
             <div class="card-body">
             <h5 class="title border-bottom">İcon resim güncelleme formu</h5>
             <form action="" method="post" enctype="multipart/form-data">
             <p class="card-text">
             <input type="file" name="dosya" /></p>
             <p class="card-text"><input type="hidden" name="introId" value="<?php echo $gelenşntroid; ?>"/></p>
             <div id="formsubmitbutton">
             <input type="submit" name="buton" value="YÜKLE" class="btn btn-primary mb-1" onclick="ButtonClicked()" />
             </div>
             <div id="buttonreplacement" style="margin-left:30px; display:none;">
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    function logoayar($vt){
        echo '<div class="row text-center">
        <div class="col-lg-12">
		 <p class="card-text text-center text-danger border-bottom">
      * Logo değiştirmek için kullanılır. <br/><br/>
      </p>
    ...
    //$introbilgiler=$vt->prepare("select * from logo");
    $introbilgiler=self::sorgum($vt,"select * from logo",2);
    while($sonbilgi=$introbilgiler->fetch(PDO::FETCH_ASSOC)):
        echo '<div class="col-lg-4">
        <div class="row card-bordered  p-1 m-1">
        <div class="col-lg-12">
        <img src="../'.$sonbilgi["logoyol"].'">
        <kbd class="bg-white p-2" style="position:absolute; bottom:10px; right:10px;">
        <a href="control.php?sayfa=logoresimguncelle&id='.$sonbilgi["id"].'" class="ti-reload m-2 text-success" style="font-size:20px;"></a>
        </kbd>
        </div>
    ...
    function  logoresimguncelleme($vt){
        ...
        if($_POST):
            ...
            if($_FILES["dosya"]["name"]==""):
                echo '<div class="alert alert-danger mt-5">
                Dosya yüklenmedi, bu alan boş olamaz.</div>';
                header("refresh:2,url=control.php?sayfa=logoayar");
            else://bos degilese
                if($_FILES["dosya"]["size"]>(1024*1024*5)):
                    echo '<div class="alert alert-danger mt-5">
                    Dosya boyutu çok fazla!</div>';
                    ...
                    if(!in_array($_FILES["dosya"]["type"],$izinverilen)):
                       ...
                       header("refresh:2,url=control.php?sayfa=logoayar");
                        ...
                        //olanı sil yeniyi kaydet
                        $resimyolunabak=self::sorgum($vt,"select * from  logo where id=$gelenintroid",1);
                        $dbgelenyol='../'.$resimyolunabak["logoyol"];
                        unlink($dbgelenyol);
                        $dosyaminyolu='../img/logo/'.$_FILES["dosya"]["name"];
                    
                        move_uploaded_file($_FILES["dosya"]["tmp_name"],$dosyaminyolu);
                        $dosyaminyolu2=str_replace('../','',$dosyaminyolu);
                        self::sorgum($vt,"update  logo set logoyol='$dosyaminyolu2' where id=$gelenintroid",0);
                        echo '<div class="alert alert-success mt-5">
                        Güncelleme başarılı.</div>';
                        header("refresh:2,url=control.php?sayfa=logoayar");
...
//veritabanına ekleme-----------
             ...
             <div class="card card-bordered">
             <div class="card-body">
             <h5 class="title border-bottom">Logo resim güncelleme formu</h5>
             <form action="" method="post" enctype="multipart/form-data">
             <p class="card-text">
             <input type="file" name="dosya" /></p>
             <p class="card-text">
...
function mesajdetay($vt,$id){
    $mesajbilgi=self::sorgum($vt,"select * from gelenmail where id=$id",1);
            ...
            <i class="fa fa-arrow-circle-left border-right pr-2 text-dark" onclick="reload"></i></a>        
