...
<head>
<link rel="icon" type="image/png" href="img/icon/download-removebg-preview.png">
  <meta charset="utf-8">
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="control.php" id="solust" style="color:white">UDEMY NAKLİYAT</a>
                </div>
            </div>
            <div class="main-menu">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a href="control.php?sayfa=iconayar"><i class="ti-palette"></i> <span>İcon Ayarı</span></a></li>
                <li><a href="control.php?sayfa=logoayar"><i class="ti-paint-roller"></i> <span>Site Logo Ayarı</span></a></li>
                </ul>
                </li>
                </ul>
                    </nav>
                ...
                <div class="row align-items-center">
                    ...
                    <!-- profil ayarlar çıkıs -->
                     <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right "style="max-height:60px;" >
                        <span></span>
                            <span></span>
                            <span></span>
            ...
            <div class="main-content-inner">
               ...
               <div class="row">
                    ...
                    <?php 
                     ...
                     ////////////////////////////////////////////////////////////////////////////////
                     case "iconayar":
                    $yonetim->iconayar($baglanti); 
                     break;
                     case "iconresimguncelle":
                     $yonetim->iconresimguncelleme($baglanti); 
                     break;
                     case "iconresimsil":
                     $yonetim->iconsil($baglanti); 
                     break;
                     case "iconresimekle":
                     $yonetim->iconresimekleme($baglanti);
                     break;
                     //////////////////////////////////////////////////////////////////////////////
                     case "logoayar":
                     $yonetim->logoayar($baglanti); 
                     break;
                     case "logoresimguncelle":
                     $yonetim->logoresimguncelleme($baglanti); 
                     break;
                     case "logoresimsil":
                     $yonetim->iconsil($baglanti); 
                     break;
