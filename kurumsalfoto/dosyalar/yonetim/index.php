...
<head>
<link rel="shortcut icon" type="image/png" href="../<?php echo ["iconyol"] ?>"/>
  <meta charset="utf-8">
...
<div class="login-area text-center">
    ...
    ?>
        ...
        if($kulad=="" && $sifre==""):
            ...
            <div class="alert alert-white border border-dark mt-5 col-md-5 mx-auto p-3 text-danger font-14 font-weight-bold"><img src="load.gif" class="mr-3">Bilgiler boş olamaz</div>
            </div>';
