...
<meta name="iconyol" content="<?php echo $sinif->iconyol; ?>"/>
<meta name="logoyol" content="<?php echo $sinif->logoyol; ?>"/>
...
<div class="container">
<div id="logo" style="max-width:auto;" class="pull-left">  
<h1><a href="#body" class="scrollto"><img style="width:auto; height:100px;" src="<?php echo $sinif->logoyol; ?>"/></a></h1>
</div>
...
<a href="oyun.html"<button type="button" class="btn btn-link" style="color:#<?php echo $sinif->renkkodu; ?>">Link</button></a>
<!-- footer -->
